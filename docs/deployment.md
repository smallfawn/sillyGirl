...
wget https://github.com/smallfawn/sillyGirl/releases/download/v0.0.6/sillyGirl_v0.0.6_linux_amd64.tar.gz
tar -xzf sillyGirl_v0.0.6_linux_amd64.tar.gz
mv sillyGirl_v0.0.6_linux_amd64 sillyGirl
chmod +x sillyGirl
