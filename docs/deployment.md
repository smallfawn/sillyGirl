...
wget https://github.com/smallfawn/sillyGirl/releases/download/V0.2.2/sillyGirl_V0.2.2_linux_amd64.tar.gz
tar -xzf sillyGirl_V0.2.2_linux_amd64.tar.gz
mv sillyGirl_V0.2.2_linux_amd64 sillyGirl
chmod +x sillyGirl
...
后台或官方命令插件执行更新时，会通过 GitHub 加速地址下载最新 Release 包并替换程序文件，不需要挂载 Docker socket。
